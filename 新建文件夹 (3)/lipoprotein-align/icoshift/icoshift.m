...
% 230315 (FrSa) Bugfix: ref_alignment with correct use of "average2"
%% ERRORS CHECK
% Constant
...
elseif isa(n,'numeric')
    ...
    if scfl && n ~= fix(n),  wmsg = sprintf('"n" must be an integer if Scal is ignored; first element (i.e. %i) used',round(n));
